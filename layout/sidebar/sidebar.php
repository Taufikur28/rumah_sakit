            ...
            <div class="main">
                ...
                <div class="list-item">
                    <a href="../../admin/admin.php">
                        <img src="img/dashboard.svg" alt="" class="icon">
                        <span class="description">Data Admin</span>
                    </a>
                </div>
                <div class="list-item">
                ...
                <div class="list-item">
                    <a href="../../jadwal/data_booking.php">
                        <img src="img/team.svg" alt="" class="icon">
                        <span class="description">Data Booking</span>
                    </a>
                </div>
                <div class="list-item">
                    <a href="../../obat/data_obat_adm.php">
                        <img src="img/event.svg" alt="" class="icon">
                        <span class="description">Data Obat</span>
                    </a>
                </div>
                <div class="list-item">
                    <a href="../../obat/data_pesanan.php">
                        <img src="img/team.svg" alt="" class="icon">
                        <span class="description">Pemesanan Obat</span>
                    </a>
                </div>
