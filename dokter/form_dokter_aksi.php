...
if (isset($_POST['kirim'])){
    ...
    $simpan = "INSERT INTO data_dokter (
        nama, tempat_lahir, tanggal_lahir, umur, jns_kel, alamat, spesialisasi, notelp, email, pass, foto)
        VALUES ('$nama', '$tempat_lahir', '$tanggal_lahir', '$umur', '$jns_kel', '$alamat', '$spesialisasi', '$notelp', '$email', '$pass', '$foto')";
