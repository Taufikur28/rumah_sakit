...
if (isset($_POST['kirim'])){
    ...
    $simpan = "INSERT INTO data_pasien(
        nama,tempat_lahir,tanggal_lahir,jns_kel,alamat,nama_pngjwb,hubungan,notelp,email,pass,foto)
        VALUES('$nama','$tempat_lahir','$tanggal_lahir','$jns_kel','$alamat','$nama_pngjwb','$hubungan','$notelp','$email','$pass','$foto')";
